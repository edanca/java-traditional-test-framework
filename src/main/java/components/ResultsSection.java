...
public class ResultsSection extends Base {
    ...
    private By byResultItemsDisclaimer = By.cssSelector(".item__title .main-title");
    ...
    public List<WebElement> resultItemsDisclaimer() { return this.getWebElements(byResultItemsDisclaimer); }
}
